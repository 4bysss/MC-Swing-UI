...
public class MiInterfazDeUsuario {
    ...
    MiInterfazDeUsuario(){
        ...
        boton1 = new JButton("Tumorcito tumorcito");
        boton2 = new JButton("belZub");
        ...
        JMenuItem IEncryp = new JMenuItem("Encriptador");
        //Submenu al menu 3
        ...
        public void actionPerformed(ActionEvent arg0) {
            urmInterpreter execute = new urmInterpreter();
        }});
        ...
        IEncryp.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                cifraVernam encript = new cifraVernam();
            }
        });
