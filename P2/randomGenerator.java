                ...
                switch (Metodo) {
                    case "26.1a":
                        ...
                        for (int i = 0; i < numPuntos; i++) {
                            ...
                            System.out.println("Sin normalizar tenemos "+unnormalizedX+" una vez normalizado nos queda "+normalizedX+"Y pasado a coordenada tenemos" + (int)(normalizedX*ancho));
