...
public class MiInterfazDeUsuario {
    ...
    MiInterfazDeUsuario(){
        //Imagen del mono
        ImageIcon ImagenMono = new ImageIcon(new ImageIcon("./cover4.jpg").getImage().getScaledInstance(720, 720, Image.SCALE_SMOOTH));
        ...
        JMenuItem ISocorro = new JMenuItem("Llama al 112");
        //Submenu al menu 3
        ...
        public void actionPerformed(ActionEvent arg0) {
            mostrarVentana("SOCORRO ME TIENEN ENCERRADO EN UN SOTANO HACIENDO UNA INTERFAZ EN JAVA LLAMA A LA POLICIA!!!");
        }});
